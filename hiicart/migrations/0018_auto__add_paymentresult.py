...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hiicart_paymentresponse', (
            ...
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_results', to=orm['hiicart.HiiCart'])),
        ...
        db.send_create_signal('hiicart', ['PaymentResponse'])


    def backwards(self, orm):
        
        # Deleting model 'PaymentResponse'
        db.delete_table('hiicart_paymentresponse')
    ...
    models = {
        ...
        'hiicart.paymentresponse': {
            'Meta': {'object_name': 'PaymentResponse'},
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_results'", 'to': "orm['hiicart.HiiCart']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
